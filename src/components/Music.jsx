...
//                     <div key={index} className="p-4 flex-wrap flex items-center justify-center flex-col text-center border-4 border-neutral-500 rounded hover:scale-105  transition-all ">
